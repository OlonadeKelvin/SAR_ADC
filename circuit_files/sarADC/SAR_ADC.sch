...
N -15 -515 -15 -180 {lab=VDD}
N 565 -60 605 -60 {lab=ValidDelayed}
...
N 565 -100 585 -100 {lab=VDD}
N 565 -80 585 -80 {lab=0}
...
N -10 -60 65 -60 {lab=0}
N -85 155 -10 155 {lab=0}
N -85 -285 -85 155 {lab=0}
N -85 -285 10 -285 {lab=0}
...
C {vsource.sym} -1170 160 0 0 {name=V5 value="sin(0 -1.65 200000)" savecurrent=false}
C {vsource.sym} -1170 235 0 0 {name=V6 value=1.65 savecurrent=false}
C {vsource.sym} -1095 20 0 0 {name=V7 value="sin(0 1.65 200000)" savecurrent=false}
...
set num_threads 1
run
write testWhole_saturationScheme.raw
.endc
"
spice_ignore=false
      }
